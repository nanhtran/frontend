...
const FilterSection = () => {
  ...
  // const clearAllFilters = () => {
  //   const newSearchParams = new URLSearchParams(); // Tạo một đối tượng mới
  //   setSearchParams(newSearchParams); // Cập nhật trạng thái React
  //   console.log("Filters cleared:", newSearchParams.toString()); // Kiểm tra kết quả
  // };

  return (
    <div className="-z-50 space-x-0-y-5 bg-white">
